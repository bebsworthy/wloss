...
- **Headline pair:** raw weigh-in (small) + canonical trend weight (hero) + weekly rate ("−0.6 kg/wk"). After a full 30-calendar-day window exists, the trend card adds one neutral fact ("30-day trend −1.3 kg"). The canonical trend remains the single headline answer; the 30-day value has no goal coloring or alternate-number status.
